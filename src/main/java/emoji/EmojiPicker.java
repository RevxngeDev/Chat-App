...
/**
 * Clase que representa un selector de emojis para su uso en la interfaz gráfica.
 * Proporciona una lista de emojis que se pueden seleccionar.
 */
public class EmojiPicker extends VBox {
    private ListView<String> emojiListView;
    /**
     * Constructor que inicializa el EmojiPicker y carga la lista de emojis disponibles.
     */
    public EmojiPicker() {
